        ...
        public List<entMuebleTerminado> ListarMuebleTerminado()
        {
            ...
            try
            {
                ...
                while (dr.Read())
                {
                    ...
                    Mue.OrdendeproduccionID = Convert.ToInt32(dr["OrdendeproduccionID"]);
                    Mue.PlanodemuebleID = Convert.ToInt32(dr["PlanodemuebleID"]);
                    Mue.TipotinteID = Convert.ToInt32(dr["TipotinteID"]);
